            ...
            <div class="row">
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        ...
                        <div class="card-footer p-3" style="display: none;">
                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">Usuarios Matriculados</p>
                                <h4 class="mb-0">60</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">Usuarios Aprobados</p>
                                <h4 class="mb-0">40</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
            ...
            <div class="row mt-4">
                <div class="col-lg-4 col-md-6 mt-4 mb-4">
                    <div class="card z-index-2 ">
                        ...
                        <div class="card-body">
                            <h6 class="mb-0 ">Ingresos a la semana</h6>
                            <p class="text-sm ">Ingreso de usuarios por día de la semana</p>
                ...
                <div class="col-lg-4 col-md-6 mt-4 mb-4">
                    <div class="card z-index-2  ">
                        ...
                        <div class="card-body">
                            <h6 class="mb-0 ">Inscritos por ejecución</h6>
                            <p class="text-sm ">Numero de inscritos en los últimos 8 meses</p>
                            <hr class="dark horizontal">
                            <div class="d-flex" style="display: none !important;">
                                <i class="material-icons text-sm my-auto me-1">schedule</i>
                ...
                <div class="col-lg-4 mt-4 mb-3">
                    <div class="card z-index-2 ">
                        ...
                        <div class="card-body">
                            <h6 class="mb-0 ">Matriculados por ejecución</h6>
                            <p class="text-sm ">Numero de matriculados en los últimos 8 meses</p>
                            <hr class="dark horizontal">
                            <div class="d-flex"  style="display: none !important;">
                                <i class="material-icons text-sm my-auto me-1">schedule</i>
